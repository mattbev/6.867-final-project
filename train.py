...
def train(
    ...
    for i in range(training_steps):
        ...
        generator_discriminator_out = discriminator(generated_data).squeeze()
        ...
        true_discriminator_out = discriminator(true_data).squeeze()
        true_discriminator_loss = loss(true_discriminator_out, true_labels)

        # add .detach() here think about this
        generator_discriminator_out = discriminator(generated_data.detach()).squeeze()
